          ...
          <div>
            ...
            <div className="mt-6 flex items-center space-x-3">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-slate-700 hover:text-white hover:border-white/50 transition-colors"
