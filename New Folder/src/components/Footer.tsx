        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-200">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-extrabold tracking-wider text-slate-900 font-heading">
                TS SPORTS
              </span>
            </div>
            ...
            <button
              ...
              className="mt-4 px-4 py-2.5 rounded-xl bg-emerald-500/10 border border-slate-900/20 text-slate-950 hover:bg-slate-900/10 transition-all text-xs font-bold flex items-center space-x-2"
            >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <button onClick={() => navigateTo('showrooms')} className="hover:text-white transition-colors">
              ...
              <li>
                <button onClick={() => navigateTo('blogs')} className="hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <button onClick={() => navigateTo('suppliers')} className="hover:text-white transition-colors">
              ...
              <li>
                <button 
                  ...
                  className="hover:text-white transition-colors flex items-center space-x-1 text-slate-600"
                >
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs">
              ...
              <li className="flex items-center space-x-2.5">
                ...
                <a href={`mailto:${settings.contactEmail}`} className="hover:underline text-slate-950 font-semibold">{settings.contactEmail}</a>
              </li>
              <li className="flex items-center space-x-2.5">
                <Phone className="w-4 h-4 text-slate-950 flex-shrink-0" />
                <span className="font-bold text-slate-950 font-mono">03085410293</span>
              </li>
            </ul>
            ...
            <div className="mt-6 flex items-center space-x-3">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="w-8 h-8 rounded-lg bg-slate-100 border border-slate-300 flex items-center justify-center text-slate-700 hover:bg-slate-900 hover:text-white hover:border-slate-900 transition-colors"
