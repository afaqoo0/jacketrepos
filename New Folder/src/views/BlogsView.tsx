      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filtered.map((blog) => (
          <div
            ...
            className="glass-card rounded-3xl overflow-hidden cursor-pointer flex flex-col justify-between group hover:border-white/50 transition-all duration-300"
          >
            <div className="aspect-[16/9] bg-white overflow-hidden relative">
              ...
              />
              <div className="absolute top-3 left-3 px-3 py-1 rounded-full text-[10px] font-bold uppercase bg-slate-950 text-white font-heading">
                {blog.category}
              </div>
            </div>
            ...
            <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
              <div className="space-y-2">
                ...
                <h3 className="text-lg font-bold text-slate-950 group-hover:text-white transition-colors font-heading leading-snug">
                  {blog.title}
                </h3>
