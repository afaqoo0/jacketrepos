      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl border border-slate-200 space-y-6 shadow-2xl">
        ...
        <form onSubmit={handleLogin} className="space-y-4" autoComplete="off">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white border border-slate-200 text-xs text-slate-950 placeholder-slate-500 focus:outline-none focus:border-white"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 rounded-xl text-xs font-extrabold text-white bg-gradient-to-r from-slate-900 to-slate-700 hover:from-slate-800 hover:to-slate-600 shadow-lg shadow-slate-900/20 flex items-center justify-center space-x-2 transition-all font-heading disabled:opacity-50"
          >
            {loading ? (
              <>
