    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="glass-card p-8 rounded-3xl border border-slate-900/50 space-y-6 shadow-2xl bg-gradient-to-br from-slate-900/90 to-slate-50">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 rounded-2xl bg-slate-900/20 text-slate-950 border border-slate-900/30 flex items-center justify-center">
            ...
            <div className="space-y-3 text-xs text-slate-700 pt-2 border-t border-slate-200">
              <p className="flex items-center space-x-2">
                <Globe className="w-4 h-4 text-slate-950 flex-shrink-0" />
                <span><strong>Access:</strong> Available Online 24/7 Worldwide</span>
              </p>

              <p className="flex items-center space-x-2">
                <Phone className="w-4 h-4 text-slate-950 flex-shrink-0" />
                <span><strong>Instant Support & Orders:</strong> <span className="font-mono text-slate-950 font-bold">03085410293</span></span>
              </p>

              <p className="flex items-start space-x-2 text-slate-600">
                <Clock className="w-4 h-4 text-slate-950 flex-shrink-0 mt-0.5" />
            ...
            <div className="pt-3 flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 py-3 px-4 rounded-xl text-xs font-extrabold text-white bg-gradient-to-r from-slate-900 to-slate-700 hover:from-slate-800 hover:to-slate-600 shadow-md flex items-center justify-center space-x-2 font-heading"
              >
        ...
        <div className="lg:col-span-6">
          <div className="glass-panel p-4 rounded-3xl border border-slate-200 space-y-4">
            <div className="aspect-[16/10] rounded-2xl overflow-hidden relative border border-slate-200 shadow-xl">
              <img
                src="/hero-pairs.jpg"
              ...
              <div className="absolute bottom-4 left-4 right-4 glass-card p-4 rounded-xl border border-slate-300">
                <span className="text-[10px] font-bold text-slate-950 uppercase tracking-widest font-heading">
                  Interactive Catalog
                </span>
