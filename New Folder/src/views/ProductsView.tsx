...
export const ProductsView: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      {/* Header Banner */}
      <div className="glass-panel p-8 sm:p-10 rounded-3xl border border-slate-200 space-y-4 text-center sm:text-left relative overflow-hidden">
        <div className="absolute top-0 right-0 p-8 opacity-10 hidden sm:block">
          <ShoppingBag className="w-48 h-48 text-slate-950" />
        </div>
      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 glass-card p-4 rounded-2xl border border-slate-200">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all ${
                selectedCategory === cat
                  ? 'bg-slate-950 text-white shadow-md shadow-slate-900/20 font-heading'
        ...
        <div className="relative w-full md:w-72">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl bg-white border border-slate-200 text-xs text-slate-950 placeholder-slate-500 focus:outline-none focus:border-white transition-colors"
          />
          {searchQuery && (
            <button
      ...
      {filteredProducts.length > 0 ? (
        ...
        <div className="text-center py-20 glass-panel rounded-3xl border border-slate-200 space-y-4">
          <ShoppingBag className="w-12 h-12 text-slate-600 mx-auto" />
          <h3 className="text-lg font-bold text-slate-800 font-heading">No Products Found</h3>
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-slate-100 text-xs font-bold text-slate-950 hover:bg-slate-200 font-heading"
          >
            Reset Filters
          </button>
        </div>
